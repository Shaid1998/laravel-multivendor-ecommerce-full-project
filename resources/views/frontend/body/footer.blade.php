...
$setting = App\Models\SiteSetting::find(1);
 ...
 <footer class="main">
   ...
   <a href="index.html" class="mb-15"><img src="{{ asset($setting->logo ?? 'None' ) }}" alt="logo" /></a>
                                <p class="font-lg text-heading">Awesome grocery store website Ecommerce</p>
                            </div>
<ul class="contact-infor">
    <li><img src="{{ asset('frontend/assets/imgs/theme/icons/icon-location.svg') }}" alt="" /><strong>Address: </strong> <span> {{ $setting->company_address ?? 'None' }} </span></li>
    <li><img src="{{ asset('frontend/assets/imgs/theme/icons/icon-contact.svg') }}" alt="" /><strong>Call Us:</strong><span>{{ $setting->phone_one  ?? 'None' }}</span></li>
    <li><img src="{{ asset('frontend/assets/imgs/theme/icons/icon-email-2.svg') }}" alt="" /><strong>Email:</strong><span>{{ $setting->email  ?? 'None' }}</span></li>
        ...
        <div class="container pb-30 wow animate__animated animate__fadeInUp" data-wow-delay="0">
            <div class="row align-items-center">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <p class="font-sm mb-0">&copy; 2022, <strong class="text-brand">Ecommerce</strong> -  {{ $setting->copyright  ?? 'None' }}</p>
                </div>
    ...
    <a href="{{ $setting->youtube  ?? 'None' }}"><img src="{{ asset('frontend/assets/imgs/theme/icons/icon-youtube-white.svg') }}" alt="" /></a>
</div>
